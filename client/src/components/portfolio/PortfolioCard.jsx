...
export default function PortfolioCard({ project, className = '' }) {
  ...
  return (
    <Link
      ...
      className={`group relative block overflow-hidden rounded-4xl bg-white shadow-soft transition-shadow duration-500 hover:shadow-lift ${className}`}
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end p-5 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
          <span className="inline-flex items-center gap-2 rounded-full bg-gold px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-navy">
