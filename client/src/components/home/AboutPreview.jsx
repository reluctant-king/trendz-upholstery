    ...
    <section className="bg-cream py-20 md:py-28">
      <div className="container-px grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
        <Reveal className="relative">
          <div className="overflow-hidden rounded-[2.5rem] shadow-lift">
            <Image
              src={
                settings.aboutImage ||
                'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=1200&q=80&fm=auto&fit=crop'
              }
          ...
          <div className="absolute -bottom-6 left-6 rounded-3xl bg-deep px-6 py-5 text-white shadow-lift">
            <p className="font-display text-3xl text-gold">{settings.yearsExperience || '15+'}</p>
        ...
        <div>
          <SectionHeading
            eyebrow="About Us"
            title={settings.aboutHeading || 'About Our Craft'}
            subtitle={
              settings.aboutShortDescription ||
