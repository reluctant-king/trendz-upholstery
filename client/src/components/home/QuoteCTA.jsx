...
export default function QuoteCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-gold py-16 md:py-20">
      ...
      <div className="pointer-events-none absolute -right-16 bottom-0 h-72 w-72 rounded-full bg-deep/15 blur-3xl" />
      <div className="container-px relative flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
        <Reveal className="max-w-xl">
          <span className="text-[11px] font-semibold uppercase tracking-eyebrow text-deep/70">Ready When You Are</span>
          <h2 className="mt-3 font-display text-3xl leading-tight text-deep sm:text-4xl md:text-5xl">
            Have a Project in Mind?
          </h2>
          <p className="mt-3 text-base text-deep/70">
        ...
        <Reveal delay={0.15} className="flex flex-wrap items-center gap-4">
          <Link to="/quote" className="btn bg-deep text-white px-8 py-4 hover:bg-black">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="btn border-2 border-deep/30 px-8 py-[14px] text-deep hover:border-deep hover:bg-deep hover:text-white"
          >
